...
export const ToastProvider = ({ children }) => {
    ...
    const notify = (action) => {
        switch (action) {
            case "addToCart":
                return toast.success("Item Added to cart!", { position: "bottom-right", autoClose: 2000 })
            case "removeFromCart":
                return toast.error("Item Removed From cart!", { position: "bottom-right", autoClose: 2000 })
            case "addToWishlist":
                return toast.success("Item Added To Wishlist!", { position: "bottom-right", autoClose: 2000 })
            case "removeFromWishlist":
                return toast.error("Item Removed From Wishlist!", { position: "bottom-right", autoClose: 2000 })
            ...
            case "userLoggedOut":
                return toast.error("Logged Out Successfully!", { position: "bottom-right", autoClose: 2000 })
            case "pleaseLogin":
