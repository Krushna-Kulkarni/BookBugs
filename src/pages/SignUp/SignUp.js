    ...
    <div className="signUpMain">
        <div className="signUpDiv">
           ...
           <div className='signUpInputsDiv'>
                ...
                <input required className="passwordInputDiv" type={shouldShowPassword.pass ? "text":"password"} placeholder='Password'/>
                ...
                <input required className="confirmPasswordInputDiv" type={shouldShowPassword.confirmPass ? "text":"password"} placeholder='Confirm Password'/>
