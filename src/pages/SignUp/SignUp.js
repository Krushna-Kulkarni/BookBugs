    ...
    <div className="signUpMain">
        <div className="signUpDiv">
           ...
           <div className='signUpInputsDiv'>
                <input className="firstName" name="firstName" type="text" placeholder="First Name"/>
                <input className="lastName" name="lastName"  type="text" placeholder="Last Name"/>
                <input className="email" name="email" type="email" placeholder="Email"/>
                <input required className="passwordInputDiv" name="password" type={shouldShowPassword ? "text":"password"} placeholder='Password'/>
            ...
            <div className='signUpActionBtns'>
                <button type="submit" className='signUpActionBtn'>signUp</button>
            </div>
